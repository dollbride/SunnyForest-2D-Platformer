...
namespace Platformer.GameElements
{
    public class Ladder : MonoBehaviour
    {
        ...
        private void OnDrawGizmos()
        {
            ...
            Gizmos.DrawLine(Vector2.left * 0.08f + upEnter,
                            Vector2.right * 0.08f + upEnter);
            Gizmos.DrawLine(Vector2.left * 0.08f + upExit,
                            Vector2.right * 0.08f + upExit);

            Gizmos.color = Color.magenta;
            Gizmos.DrawLine(Vector2.left * 0.08f + downEnter,
                            Vector2.right * 0.08f + downEnter);
            Gizmos.DrawLine(Vector2.left * 0.08f + downExit,
                            Vector2.right * 0.08f + downExit);
        }
    }
}
