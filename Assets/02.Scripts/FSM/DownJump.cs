...
namespace Platformer.FSM.Character
{
    public class DownJump : CharacterStateBase
    {
        ...
        public DownJump(CharacterMachine machine, float jumpForce = 1.0f, float ignoringDistance = 0.2f) : base(machine)
        {
        ...
        public override CharacterStateID OnStateUpdate()
        {
            ...
            switch (_step)
            {
                ...
                case 4:
                    ...
                    break;
                // case 1, 2, 3이 없으니까 안 썼지만 디폴트로 왔다가 나가면서 아래 에러 체크 
            }
        ...
        public override void OnStateFixedUpdate()
        {
            ...
            switch (_step)
            {
                ...
                case 1:
                    ...
                    break;
                // 살짝 뛰었다가 원래 밟고 있던 땅을 다시 지나가기 시작하는지 체크
                case 2:
                    {
                        if (controller.isGrounded)
                        {
                    ...
                    break;
                // 원래 밟고 있던 땅을 무시하고 일정 거리를 지나갔는지 체크. 더이상 무시하지 않음 
                case 3:
                    {
